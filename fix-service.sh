...
if command -v chcon &> /dev/null; then
    sudo chcon -t bin_t /home/tidesk/TIDESK/start-tidesk.sh 2>/dev/null || \
    sudo chcon -u system_u -t bin_t /home/tidesk/TIDESK/start-tidesk.sh 2>/dev/null || \
    echo "⚠️  Não foi possível configurar contexto SELinux automaticamente"
fi

# Atualiza o serviço
sudo cp /home/tidesk/TIDESK/tidesk.service /etc/systemd/system/tidesk.service
